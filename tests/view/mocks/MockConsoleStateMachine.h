...
public:
    MOCK_METHOD(std::shared_ptr<WizardContext>, Run, (const std::shared_ptr<WizardContext>& context, const std::shared_ptr<WizardStateConsole>& initial_state), (override));
};
