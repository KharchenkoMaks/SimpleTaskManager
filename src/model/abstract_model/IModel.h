...
public:
    ...
    virtual bool DeleteTask(const TaskId& id, bool force_delete_subtasks = false) = 0;
    virtual bool CompleteTask(const TaskId& id, bool force_complete_subtasks = false) = 0;
