...
CommandResult CommandResult::Create(const TaskActionResult result) {
...
CommandResult CommandResult::Create(const TaskId& task_id) {
    CommandResult cmd_result;
    cmd_result.result_ = TaskActionResult::SUCCESS;
...
TaskActionResult CommandResult::GetResult() const {
    return result_;
}
