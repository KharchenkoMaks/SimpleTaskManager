...
std::unique_ptr<CommandInterface> CommandFactory::CreateAddTaskCommand(const WizardContext& context) {
...
std::unique_ptr<CommandInterface> CommandFactory::CreateAddSubTaskCommand(const WizardContext& context) {
    std::optional<Task> task_to_add = context.GetTask();
...
std::unique_ptr<CommandInterface> CommandFactory::CreateEditCommand(const WizardContext& context) {
...
std::unique_ptr<CommandInterface> CommandFactory::CreateCompleteCommand(const WizardContext& context) {
...
std::unique_ptr<CommandInterface> CommandFactory::CreateDeleteCommand(const WizardContext& context) {
    std::optional<TaskId> task_id = context.GetTaskId();
    if (task_id.has_value())
...
std::unique_ptr<CommandInterface> CommandFactory::CreateSetLabelCommand(const WizardContext& context) {
    std::optional<TaskId> task_id = context.GetTaskId();
...
std::unique_ptr<CommandInterface> CommandFactory::CreateShowCommand(const WizardContext& context) {
    return std::make_unique<ShowTasksCommand>(controller_);
}

std::unique_ptr<CommandInterface> CommandFactory::CreateSaveCommand(const WizardContext& context) {
...
std::unique_ptr<CommandInterface> CommandFactory::CreateLoadCommand(const WizardContext& context) {
    std::string file_name = context.GetFileName();
    if (!file_name.empty())
